...
require (
	...
	github.com/project-eria/xaal-go/message v0.0.1
	github.com/project-eria/xaal-go/messagefactory v0.0.1
	github.com/project-eria/xaal-go/network v0.0.1
	github.com/project-eria/xaal-go/utils v0.0.1
