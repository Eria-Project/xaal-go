...
func Test_encodeMsg(t *testing.T) {
	msg := message.Message{Body: map[string]interface{}{"bool": true, "int": 10, "string": "test"}, Header: message.Header{Source: "3cd47760-ce4f-11e8-a044-406c8f5172cb", DevType: "test.basic", MsgType: "notify", Action: "alive"}, Targets: []string{}, Timestamp: []int{243800445, 651387}, Version: "0.5"}
	data := []byte{}
	type args struct {
		msg     message.Message
		nowTime func() time.Time
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("encodeMsg() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_decodeMsg(t *testing.T) {
	msg := &message.Message{Body: map[string]interface{}{"bool": true, "int": float64(10), "string": "test"}, Header: message.Header{Source: "3cd47760-ce4f-11e8-a044-406c8f5172cb", DevType: "test.basic", MsgType: "notify", Action: "alive"}, Targets: []string{}, Timestamp: []int{243800445, 651387}, Version: "0.5"}
	data := []byte{}
	// +120 seconds
